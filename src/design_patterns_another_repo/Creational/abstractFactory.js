...
class tcpApiRequest extends ApiRequest {
    makeGetRequest(url) {
        return new Promise((resolve, reject) => {
            ...
            socket.on('data', (data) => {console.log("socket data rcvd"); resolve(data.toString())});
...
/* This is an abstract factory interface. Uses a static function to generate family of products */
